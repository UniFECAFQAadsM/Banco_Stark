# -*- coding: utf-8 -*-
"""04_ATIVIDADE (Banco.Stark) - KAIQUE STRUMIELLO MOCELIN - .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KDwLNuvpj7KH5hOaoNc9dOieVN7_VAod
...
**Pré-condição:** Banco do Stark carregado! + Nome
...
**Resultado esperado:** Usuário conseguir criar cadastro

**Resultado obtido:**  O usuário conseguiu criar um cadastro
...
**ID:** CT-002  
**Título/Objetivo:**  Teste N3 - Saque acima do saldo
**Pré-condição:**  Banco do Stark carregado! + Nome
**Passos:**  
1.  Acessar conta
2.  Verificar saldo
3.  Sacar saldo
**Resultado esperado:**  O usuário não conseguir relizar saques >saldo
**Resultado obtido:**  saques tem que ser <=saques
**Status (Pass/Fail):**  Pass
...
**ID:** CT-003  
**Título/Objetivo:**  Teste N4 - Transferência para conta inexistente
**Pré-condição:**  Site/ app rodando
**Passos:**  
1.  Acessar conta
2.  Verificar saldo
3.  Depositar
**Resultado esperado:**  Depósito para contas inexistentes não deve ser permitido
**Resultado obtido:**  O usuário não consegue depositar para contas inexistentes
**Status (Pass/Fail):**  Pass
...
**Descrição:**  
O usuário consegue depositar 0, mesmo não sendo permitido.
...
**Resultado esperado:**  Depositado apenas >0
