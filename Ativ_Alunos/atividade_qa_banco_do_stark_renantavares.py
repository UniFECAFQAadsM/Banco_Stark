# -*- coding: utf-8 -*-
"""Atividade_QA_Banco_do_Stark_RenanTavares.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12poxMFLcX7JsZltOBJWeLYVMF7nDdwax
...
**ID:** CT-001  
**Título/Objetivo:** Transferência para sí mesmo
**Pré-condição:** Banco estar pronto, Conta criada.
**Passos:**  
1. Carregar banco.
2. banco.transferir('tony', 'tony', 100)

**Resultado esperado:**  Erro ou "Não se pode transferir para essa conta."
...
**ID:** CT-002  
**Título/Objetivo:** Teste de Saque negativo
**Pré-condição:**  Banco estar pronto, Conta criada.
**Passos:**  
1.  Carregar banco.
2.  banco.saque('tony',-300)
**Resultado esperado:**  Bloqueio por ser negativo.
**Resultado obtido:** Saque negativo efeituado com sucesso
**Status (Pass/Fail):**  Fail
**Evidência:**  SALDO tony = 2300.0
OK - Saque realizado: -200
SALDO tony = 2500.0

## Template — Caso de Teste 3
**ID:** CT-003  
**Título/Objetivo:**  Teste Saldo negativo e deposito negativo
**Pré-condição:**  Banco estar pronto, Conta criada.
**Passos:**  
1.  Carregar banco.
2.  banco.deposito('tony',-30000)
3.  banco.saldo('tony')
**Resultado esperado:**  Bloqueio no deposito ou Saldo em 0.
**Resultado obtido:**  Deposito efeituado, Saldo -600.
**Status (Pass/Fail):**  Fail
**Evidência:**  SALDO tony = -600.0
...
**Descrição:**  Usuário pode efetuar saques negativos para aumentar seu saldo.

**Passos para reproduzir:**  
1.  Carregar banco
2.  Efetuar Saque com valor negativo
3.  Conferir Saldo

**Resultado esperado:**  Bloqueio por Saque ser igual a/menor que 0
**Resultado obtido:**  Aumento de saldo na conta.
**Evidência:**  SALDO tony = 2300.0 OK - Saque realizado: -200 SALDO tony = 2500.0
**Impacto/Risco:**  Permite efetuar criação de saldo do nada.
